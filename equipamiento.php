...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
       <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link" href="mantenedores_celular.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Mantenedor Celulares</span>
          </a>
          <a class="nav-link" href="mantenedores_Bam.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Mantenedor Bam</span>
          </a>
        </li>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <a class="btn btn-success btn-sm" href="formulario_registrar_equipo.php">Agregar nuevo equipo</a>
          <div class="card mb-4">
  ...
  <th class="text-xxs">SERIAL</th>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">PROCESADOR</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">HDD</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">RAM</th>
  ...
  <!-- inicio de tabla usuarios -->
    ...
    <?php
                foreach ($equipos as $equipo) { ?>
                    ...
                    <tr>
                     <td class="text-xxs"><small><?php echo $equipo["serial_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["marca_equipo"] ?></small></td>
                        <td class="text-xxs"><small><?php echo $equipo["modelo_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["procesador_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["capacidad_hdd_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["ram_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["valor_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["fecha_compra_equipo"] ?></small></td>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                by
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">MDA - Área TI</a>
