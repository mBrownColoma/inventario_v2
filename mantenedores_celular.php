    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link active" href="mantenedores_celular.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Mantenedores Celulares</h6>
        </nav>
      ...
      <?php
                 foreach ($modelos as $modelo) { ?>
                    ...
                    <tr>
                       ...
                       <td class="text-sm"><small><?php echo $modelo["id_modelo_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $modelo["modelo_equipo"] ?></small></td>
      ...
      <?php
                foreach ($equipos as $equipo) { ?>
                    ...
                    <tr>
                       ...
                       <td class="text-sm"><small><?php echo $equipo["id_tipo_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["tipo_equipo"] ?></small></td>
      ...
      <?php
                foreach ($marcas as $marca) { ?>
                    ...
                    <tr>
                       ...
                       <td class="text-sm"><small><?php echo $marca["id_marca_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $marca["marca_equipo"] ?></small></td>
