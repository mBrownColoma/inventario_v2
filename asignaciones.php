    ...
    <?php
                foreach ($equipos as $equipo) { ?>
                    ...
                    <input type="hidden" id="eq" value="<?php echo $equipo["id_equipo"] ?>">
                        ...
                        <td class="text-sm"><small><?php echo $equipo["serial_equipo"] ?></small></td>
                        <td class="text-xxs"><small><?php echo $equipo["marca_equipo"] ?></small></td>
                        <td class="text-sm"><small><?php echo $equipo["modelo_equipo"] ?></td></small></td>
